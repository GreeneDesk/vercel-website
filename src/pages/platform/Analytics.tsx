...
const features = [
  { icon: TrendingDown, title: "Retention risk alerts", description: "Identify at-risk members early" },
  { icon: Users, title: "Attendance patterns", description: "Understand member behaviour" },
  { icon: Activity, title: "Utilisation insights", description: "Optimise facility usage" },
  { icon: PieChart, title: "Revenue analytics", description: "Track financial performance" },
  { icon: BarChart3, title: "Custom dashboards", description: "See what matters most" },
];

const insights = [
  "Which classes are underperforming?",
  "Who's at risk of cancelling?",
  "What's driving retention success?",
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                ...
                <span className="text-gradient-primary">better retention</span>
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                Stop relying on gut feel. Get clear insights into attendance, utilisation, and retention so you can act before problems become cancellations.
              </p>
